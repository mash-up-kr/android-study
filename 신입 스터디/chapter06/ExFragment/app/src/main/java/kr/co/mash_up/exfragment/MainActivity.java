...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (DisplayUtils.isScreenOrientationLandscape(this)) {
            //가로일 때
        ...
        masterFragment.setOnListItemClickListener(new MasterFragment.OnListItemClickListener() {
            ...
            public void onItemClick(int itemType) {
                ...
                if (DisplayUtils.isScreenOrientationLandscape(MainActivity.this)) {
                    //가로
                    ...
                    //ViewPager로 Fragment를 보여준다.
                    Intent intent = new Intent(MainActivity.this, HelloPagerActivity.class);
                    intent.putExtra("HelloFragment", itemType);
